'use client'
import { addOrUpdateTask, deleteTask } from '@/src/actions/DashboardActions'
import DeleteTaskDialog from '@/src/components/custom/kanban/DeleteTaskDialog'
import EditTaskDialog from '@/src/components/custom/kanban/EditTaskDialog'
import KanbanBoard from '@/src/components/custom/kanban/KanbanBoard'
import KanbanBoardContainer from '@/src/components/custom/kanban/KanbanBoardContainer'
import KanbanColumn from '@/src/components/custom/kanban/KanbanColumn'
import KanbanTask from '@/src/components/custom/kanban/KanbanTask'
import { KanbanTaskCardMemo } from '@/src/components/custom/kanban/KanbanTaskCard'
import NoTasks from '@/src/components/custom/kanban/NoTasks'
import { useKanbanStore } from '@/src/store/kanbanStore'
import { kanbanColumns } from '@/src/utils/kanbanColumns'
import { createClient } from '@/src/utils/supabase/client'
import { DragEndEvent } from '@dnd-kit/core'
import { Column, COMPLETED_COLUMN, Project, Task, TaskDependencyRecord } from '@/types'
